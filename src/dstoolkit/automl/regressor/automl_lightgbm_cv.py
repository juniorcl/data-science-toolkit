...
class AutoMLLightGBMCV:
    """
    AutoMLLightGBMCV is a class that automates the process of training and tuning LightGBM regression models with cross-validation.
    ...
    def _get_best_params(self):
        def objective(trial):
            params = utils.lightgbm_params_space(trial, self.random_state)
