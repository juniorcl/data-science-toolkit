...
class AutoMLKMeans:
    ...
    def _get_best_pca_model_params(self):
    ...
    def _get_best_umap_model_params(self):
    ...
    def _train_base_model(self):
        ...
        return get_metrics(self.X, self.y['base_model_labels'])
    ...
    def _train_pca_model(self) -> tuple:
        ...
        return get_metrics(self.X_pca, self.y['pca_model_labels'])
    
    def _train_umap_model(self):
        ...
        return get_metrics(self.X_umap, self.y['umap_model_labels'])
